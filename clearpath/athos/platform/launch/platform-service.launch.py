...
def generate_launch_description():
    ...
    launch_arg_imu_filter = DeclareLaunchArgument(
        'imu_filter',
        default_value='/home/ubuntu/clearpath/athos/platform/config/imu_filter.yaml',
        description='')
    ...
    node_cmd_vel_bridge = Node(
        ...
        arguments=
            [
                'athos/cmd_vel@geometry_msgs/msg/Twist[ignition.msgs.Twist'
                ,
                '/model/athos/robot/cmd_vel@geometry_msgs/msg/Twist]ignition.msgs.Twist'
                ,
            ]
        ,
        remappings=
    ...
    node_odom_base_tf_bridge = Node(
        ...
        arguments=
            [
                '/model/athos/robot/tf@tf2_msgs/msg/TFMessage[ignition.msgs.Pose_V'
                ,
            ]
        ,
        remappings=
            ...
            [
                {
                    'use_sim_time': True
                    ,
                    'config_file': '/home/ubuntu/clearpath/athos/sensors/config/imu_0.yaml'
                    ,
                }
                ,
            ]
