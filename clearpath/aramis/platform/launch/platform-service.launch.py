...
def generate_launch_description():
    ...
    launch_arg_imu_filter = DeclareLaunchArgument(
        'imu_filter',
        default_value='/home/ubuntu/clearpath/aramis/platform/config/imu_filter.yaml',
        description='')
    ...
    node_cmd_vel_bridge = Node(
        ...
        arguments=
            [
                'aramis/cmd_vel@geometry_msgs/msg/Twist[ignition.msgs.Twist'
                ,
                '/model/aramis/robot/cmd_vel@geometry_msgs/msg/Twist]ignition.msgs.Twist'
                ,
            ]
        ,
        remappings=
    ...
    node_odom_base_tf_bridge = Node(
        ...
        arguments=
            [
                '/model/aramis/robot/tf@tf2_msgs/msg/TFMessage[ignition.msgs.Pose_V'
                ,
            ]
        ,
        remappings=
            ...
            [
                {
                    'use_sim_time': True
                    ,
                    'config_file': '/home/ubuntu/clearpath/aramis/sensors/config/imu_0.yaml'
                    ,
                }
                ,
            ]
