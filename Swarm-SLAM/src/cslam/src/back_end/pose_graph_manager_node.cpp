...
int main(int argc, char **argv) {
  ...
  node->declare_parameter<double>("backend.inter_robot_loop_rotation_noise_std", 0.10);
  node->declare_parameter<double>("backend.inter_robot_loop_translation_noise_std", 1.00);
  node->declare_parameter<double>("backend.inter_robot_loop_huber_k", 1.0);
