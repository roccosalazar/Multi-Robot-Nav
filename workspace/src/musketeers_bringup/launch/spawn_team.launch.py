...
def _get_robot_configs() -> List[RobotConfig]:
    """
    Return robot names and spawn poses for the default team.
    Return:
...
def _launch_setup(context: LaunchContext) -> List[Action]:
    ...
    Return:
        A list of actions that spawn the team with fixed delays.
    """
    ...
    robot_configs = _get_robot_configs()
...
def generate_launch_description() -> LaunchDescription:
    """
    Spawn three Clearpath robots with fixed spawn delays.
    """
